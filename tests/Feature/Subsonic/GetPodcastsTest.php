...
class GetPodcastsTest extends SubsonicTestCase
{
    ...
    public function listsSubscribedPodcasts(): void
    {
        ...
        $response = $this->subsonic->get('getPodcasts.view', $user, ['includeEpisodes' => 'false']);
    ...
    public function includesEpisodesByDefault(): void
    {
        ...
        $response = $this->subsonic->get('getPodcasts.view', $user);
        $this->subsonic->assertOk($response);
        $response->assertJsonStructure([
            'subsonic-response' => [
                'podcasts' => [
    ...
    public function filtersToSingleChannelById(): void
    {
        ...
        $channels = $this->subsonic->get('getPodcasts.view', $user, [
            'id' => $targetPodcast->id,
