<template>
  <FooterButton
    :title
    class="!w-[3rem] rounded-full border-2 border-solid border-k-fg-70 aspect-square !transition-transform
    hover:scale-125 !text-2xl has-[.icon-play]:indent-[0.23rem]"
