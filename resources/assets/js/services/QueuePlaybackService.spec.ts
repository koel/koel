...
new class extends UnitTestCase {
  ...
  protected test () {
    ...
    it('scrobbles if current playable ends', () => {
      ...
      const scrobbleMock = this.mock(playableStore, 'scrobble')
    ...
    it('registers play', () => {
      ...
      const registerPlayMock = this.mock(playableStore, 'registerPlay')
      const song = factory('song')
    ...
    it('preloads a playable', () => {
      ...
      this.mock(playableStore, 'getSourceUrl').mockReturnValue('/foo?token=o5afd')
      const song = factory('song')
  ...
  private setCurrentSong (song?: Playable) {
    song = reactive(song || factory('song', { playback_state: 'Playing' }))
