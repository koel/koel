...
class TwoFactorAuthenticator
{
    ...
    /**
     * Normalise a user-supplied recovery code to the canonical "XXXX XXXX ..."
     * shape generated by RecoveryCodeFactory. Strips non-alphanumeric (so
     * pasted hyphens, extra whitespace, or fully unspaced input all match),
     * uppercases, and re-groups into 4-char chunks separated by single spaces.
     */
    private static function normalizeRecoveryCode(#[SensitiveParameter] string $code): string
    {
        return Str::of($code)->replaceMatches('/[^A-Za-z0-9]/', '')->upper()->split(4)->join(' ');
    }
